...
| [aws_config_organization_conformance_pack.conformance_packs](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/config_organization_conformance_pack) | resource |
...
| [aws_s3_object.org_fedramp](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_object) | resource |
| [aws_s3_object.org_nist](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_object) | resource |
...
| <a name="input_create_conformance_packs"></a> [create\_conformance\_packs](#input\_create\_conformance\_packs) | Determines whether or not to cerate the conformance paks. False if deploying aws-config to single, non-delegated admin account. | `bool` | `true` | no |
...
| <a name="input_is_org"></a> [is\_org](#input\_is\_org) | AWS Config deployed in Organization account structure? | `bool` | `true` | no |
