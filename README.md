...
| <a name="input_create_iam_role"></a> [create\_iam\_role](#input\_create\_iam\_role) | Whether to create IAM role and policies | `bool` | `true` | no |
...
| <a name="input_existing_config_role_arn"></a> [existing\_config\_role\_arn](#input\_existing\_config\_role\_arn) | ARN of existing Config role (when create\_iam\_role = false) | `string` | `""` | no |
