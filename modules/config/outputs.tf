...
output "config_delivery_bucket" {
  description = "The S3 bucket used used for Config snapshot delivery"
  value       = var.s3_bucket_id
}

output "sns_topic_arn" {
  description = "ARN of the SNS topic used by AWS Config notifications. Null if topic is not created."
